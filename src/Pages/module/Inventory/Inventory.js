...
function Inventory() {
    ...
    function activeHeaderButton(e) {
        ...
        if (clicked.id === "finder-button") {
            if (isHide) {
                document.getElementById("inventory-panel-container").className =
                    "show";
                document.getElementById(
                    "inventory-finder-container"
                ).className = "show";
